...
function HomePage() {
  ...
  return (
    <div className="homepage-container">
      <div class="custom-shape-divider-top-1651960325-2">
        <svg
          data-name="Layer 1"
      ...
      <div className="banner">
        ...
        <Link smooth={true} to="HomeNavBar">
          <div className="arrow-banner">
            <span className="material-icons">expand_more</span>
          </div>
        </Link>
      </div>
      <div class="custom-shape-divider-bottom-1651960265">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
      ...
      <div class="custom-shape-divider-top-1651960325">
        <svg
          data-name="Layer 1"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1200 120"
