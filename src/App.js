...
import CloudSeparator from "./Components/CloudSeparator.js";
...
function App() {
  ...
  return (
    <>
     {location.pathname == "/" ? (
       <>
        <div className="custom-shape-divider-top-1651960325-2 svg-nav-bar">
        <svg
          data-name="Layer 1"
  ...
  <div className="nav-container-container" style={{top: navbarVisible? "0": "-8vh"}}>
    <div className="nav-container" style={{opacity: navbarVisible? "0.7": "1"}}>
      ...
      <Switch location={location}>
        <Route exact path="/">
          ...
          <CloudSeparator pos={100} />
          <Element name="/About">
            <About />
          </Element>
          <CloudSeparator pos={320} />
